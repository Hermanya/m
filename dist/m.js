...
M.apiListeners.push(function defineModels (m) {
  ...
  m.mapOverResourceTypes(function (resourceType) {
    typeToModel[resourceType] = Backbone.Model.extend({
      ...
      //     if (otherModel) {
      //       // sync these two
      //       otherModel.on('change', function (attrs) {
      //         this.set(attrs, {silet: true});
      //       })
      //       this.on('change', function (attrs) {
      //         otherModel.set(attrs, {silet: true});
      //       })
      //     } else {
...
},{"./main.js":5,"backbone":2}],2:[function(require,module,exports){
//     Backbone.js 1.1.2
